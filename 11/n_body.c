...
void computeForce(Particle *p1, Particle *p2, double *fx, double *fy, double *fz) {
    double dx = p2->x - p1->x;
    double dy = p2->y - p1->y;
    double dz = p2->z - p1->z;
...
void nBodySimulation(Particle *particles, int numParticles, int numSteps, FILE *outputFile) {
